...
<div class="latest-content">
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <div class="latest-item flex flex-column">
      <div class="latest-item-content flex flex-stretch">
          <?php
          /**
           * 特色图像.
           */
          ...
          <div class="latest-item-info flex flex-column">
            <h3 class="latest-item-title reset-box-model reset-font">
            ...
            <div class="latest-item-meta flex flex-between">
              ...
              <div class="meta-right dp-none dp-lg-block">
                <span class="time" title="发布时间：<?php the_time('Y-m-d'); ?>"><?php the_time('Y-m-d'); ?></span>
                <!-- .time -->
            ...
            <p class="latest-item-desc reset-box-model dp-none dp-lg-block">
              <?php
              // 子标题
            ...
            <?php the_tags('<p class="latest-item-tags flex dp-none dp-lg-block"><i class="iconfont">&#xe660;</i> ', ' , ', '</p>'); ?>
