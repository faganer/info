...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Aliyun OSS', // The plugin name.
			'slug'               => 'aliyun-oss-support', // The plugin slug (typically the folder name).
			'source'             => 'https://github.com/IvanChou/aliyun-oss-support/archive/master.zip', // The plugin source.
        ...
        array(
			'name'               => 'Lazy Load - Optimize Images', // The plugin name.
